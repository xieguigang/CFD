...
#End Region
    ...
    Private option1ToolStripMenuItem As ToolStripMenuItem
    Private option2ToolStripMenuItem As ToolStripMenuItem
    Private option3ToolStripMenuItem As ToolStripMenuItem
End Class
